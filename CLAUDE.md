...
- [ ] Next: run the full PCX160 catalog through batch ingest (page map: 1–10 skip · 11–16 color · 17–32 skip · **33–109 assembly** · 110–120 skip; ~83 paid calls) — browser-driven in admin; then color-review UI; semantic lookup; multi-brand/web-source adapter; bundle code-split.
