...
- [ ] Next: mobile M4 (visual browse machine→group→grid), M5 polish (offline indicator etc.), color-review UI, semantic lookup, multi-brand/web-source adapter, bundle code-split.
