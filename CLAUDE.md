...
- [ ] Next: clerk polish 3/4 assistant tab, 4/4 look & feel (icon/splash/theme/Indonesian); finish PCX160 catalog ingest (re-extract pages committed before the JBIG2 fix), color-review UI, semantic lookup, multi-brand/web-source adapter, bundle code-split.
