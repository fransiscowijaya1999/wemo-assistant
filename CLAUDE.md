...
- [ ] Later: mobile M3–M5 (lookup by number/name/alias → part detail, visual browse machine→group→grid, online AI fuzzy lookup), serial/variant applicability, color-review UI, semantic lookup, multi-brand/web-source adapter, bundle code-split.
