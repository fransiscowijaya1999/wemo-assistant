...
- [ ] Next: finish PCX160 catalog ingest (re-extract pages committed before the JBIG2 fix), color-review UI, semantic lookup, multi-brand/web-source adapter, bundle code-split.
