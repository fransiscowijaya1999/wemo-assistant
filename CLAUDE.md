...
- [ ] Next: PCX160 catalog ingest (PDF on Desktop; vision extraction needs an Anthropic key), color-review UI, semantic lookup, multi-brand/web-source adapter, bundle code-split.
